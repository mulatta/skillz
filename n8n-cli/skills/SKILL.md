...
# Data tables
n8n-cli datatable list [--filter '<json>' --sort field:asc --limit 20]
n8n-cli datatable get|delete <id>
...
n8n-cli datatable delete-rows <id> --filter '<json>' [--return-data] [--dry-run]
...
n8n-cli raw GET|POST|PUT|PATCH|DELETE /path [body.json]
```
